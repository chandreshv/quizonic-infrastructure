...
public class QuizonicIAMStack extends Stack {
    ...
    public QuizonicIAMStack(final Construct scope, final String id, final StackProps props) {
        ...
        CfnParameter arnUserParameter = CfnParameter.Builder.create(this, "UserArn")
                .type("String")
                .description("ARN of the user who will assume the role")
                .build();

        Role cdkDeployeRole = Role.Builder.create(this, "CDKDeployerRole")
                .assumedBy(new ArnPrincipal(arnUserParameter.getValueAsString()))
                .roleName("CDKDeployerRole")
                .build();

        PolicyStatement policyStatementForCDKDeployment = PolicyStatement.Builder.create()
                .effect(Effect.ALLOW)
                .actions(List.of(
                        "cloudformation:*",
                        "iam:PassRole",
        ...
        PolicyStatement policyStatementToAssumeRole = PolicyStatement.Builder.create()
